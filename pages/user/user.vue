<template>
	<view class="example-body">
		<uni-card :title="nickName" :extra="userName"
			...
			<view><button @click="loginout()" class="btn">登出</button></view>
		</uni-card>
		<view>
			<uni-card title="菜品" extra="喜欢和收藏的菜品"
				...
				<view>
					<view>
						<button @click="showDrawer0" class="btn">我的喜爱</button>
						<uni-drawer maskClick ref="showRight0" mode="right" :mask-click="false">
							<scroll-view style="height: 100%;" scroll-y="true">
								<view class="info">
									<text class="info-text">菜品-我的喜爱</text>
								</view>
					...
					<view>
						<button @click="showDrawer1" class="btn">我的收藏</button>
						<uni-drawer maskClick ref="showRight1" mode="right" :mask-click="false">
							<scroll-view style="height: 100%;" scroll-y="true">
								<view class="info">
									<text class="info-text">菜品-我的收藏</text>
								</view>
		...
		<view>
			<uni-card title="发布信息" extra="点赞和收藏的发布信息"
				...
				<view>
					<view>
						<button @click="showDrawer2" class="btn">我的点赞</button>
						<uni-drawer maskClick ref="showRight2" mode="right" :mask-click="false">
							<scroll-view style="height: 100%;" scroll-y="true">
								<view class="info">
									<text class="info-text">发布信息-我的点赞</text>
								</view>
					...
					<view>
						<button @click="showDrawer3" class="btn">我的收藏</button>
						<uni-drawer maskClick ref="showRight3" mode="right" :mask-click="false">
							<scroll-view style="height: 100%;" scroll-y="true">
								<view class="info">
									<text class="info-text">发布信息-我的收藏</text>
								</view>
					...
					<view>
						<button @click="showDrawer4" class="btn">我的发布</button>
						<uni-drawer maskClick ref="showRight4" mode="right" :mask-click="false">
							<scroll-view style="height: 100%;" scroll-y="true">
								<view class="info">
									<text class="info-text">发布信息-我的发布</text>
								</view>
